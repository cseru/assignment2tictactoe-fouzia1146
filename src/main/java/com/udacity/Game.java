...
public class Game {
    ...
    public String checkGameWinner(char [][]grid){
       ...
       else if((grid[0][0] == 'o' && grid[0][1] =='o' && grid[0][2] =='o')  || (grid[1][0] == 'o' && grid [1][1] =='o' && grid [1][2] =='o')|| (grid[2][0] == 'o' && grid [2][1] =='o' && grid [2][2] =='o') ||  (grid[0][0] == 'o' && grid [1][0] =='o' && grid [2][0] =='o')||(grid[0][1] == 'o' && grid [1][1] =='o' && grid [2][1] =='o')||(grid[0][2] == 'o' && grid [1][2] =='o' && grid [2][2] =='o')||(grid[0][0] == 'o' && grid [1][1] =='o' && grid [2][2] =='o')||(grid[2][0] == 'o' && grid [1][1] =='o' && grid [0][2] =='o')){
            result = "O wins";
